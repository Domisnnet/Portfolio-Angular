...
async function _performApiRequest(auth, method, path, request, customErrorMap = {}) {
  return _performFetchWithErrorHandling(auth, customErrorMap, async () => {
    ...
    const query3 = querystring(__spreadValues({
...
function __PRIVATE_validateJSON(e, t) {
  if (!__PRIVATE_isPlainObject(e)) throw new FirestoreError2(D.INVALID_ARGUMENT, "JSON must be an object");
  let n;
  ...
  if (n) throw new FirestoreError2(D.INVALID_ARGUMENT, n);
  return true;
}
var x = -62135596800;
var O = 1e6;
var Timestamp2 = class _Timestamp {
  ...
  constructor(e, t) {
    ...
    if (e < x) throw new FirestoreError2(D.INVALID_ARGUMENT, "Timestamp seconds out of range: " + e);
...
Timestamp2._jsonSchemaVersion = "firestore/timestamp/1.0", Timestamp2._jsonSchema = {
  type: property("string", Timestamp2._jsonSchemaVersion),
...
function __PRIVATE_databaseIdFromApp(e, t) {
  if (!Object.prototype.hasOwnProperty.apply(e.options, ["projectId"])) throw new FirestoreError2(D.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
  return new DatabaseId2(e.options.projectId, t);
}
var st = "__type__";
var ot = "__max__";
var _t = {
...
function __PRIVATE_extractDocumentKeysFromArrayValue(e, t) {
  return (t.arrayValue?.values || []).map(((e2) => DocumentKey2.fromName(e2.referenceValue)));
}
...
function __PRIVATE_queryNormalizedOrderBy(e) {
  ...
  if (null === t.Ie) {
    ...
    e2.has(FieldPath$12.keyField().canonicalString()) || t.Ie.push(new OrderBy(FieldPath$12.keyField(), n));
  }
  return t.Ie;
}
...
var Tt = new SortedMap(DocumentKey2.comparator);
var It = new SortedSet(DocumentKey2.comparator);
...
var __PRIVATE_TargetState = class {
  ...
  constructor(e) {
    ...
    this.Me = ByteString2.EMPTY_BYTE_STRING, this.xe = false, /**
...
function __PRIVATE_fromWatchChange(e, t) {
  ...
  if ("targetChange" in t) {
    ...
    const r = (function __PRIVATE_fromWatchTargetChangeState(e2) {
      ...
      return e2.useProto3Json ? (__PRIVATE_hardAssert(void 0 === t2 || "string" == typeof t2, 58123), ByteString2.fromBase64String(t2 || "")) : (__PRIVATE_hardAssert(void 0 === t2 || // Check if the value is an instance of both Buffer and Uint8Array,
      // despite the fact that Buffer extends Uint8Array. In some
      // environments, such as jsdom, the prototype chain of Buffer
      // does not indicate that it extends Uint8Array.
      t2 instanceof Buffer || t2 instanceof Uint8Array, 16193), ByteString2.fromUint8Array(t2 || new Uint8Array()));
...
var __PRIVATE_MemoryDocumentOverlayCache = class {
  constructor() {
    this.overlays = new SortedMap(DocumentKey2.comparator), this.Br = /* @__PURE__ */ new Map();
  }
  getOverlay(e, t) {
...
var __PRIVATE_DocReference = class {
  ...
  static kr(e, t) {
    return DocumentKey2.comparator(e.key, t.key) || __PRIVATE_primitiveComparator(e.jr, t.jr);
  }
  /** Compare by ID then by key */
  static Kr(e, t) {
    return __PRIVATE_primitiveComparator(e.jr, t.jr) || DocumentKey2.comparator(e.key, t.key);
  }
};
...
var __PRIVATE_RestConnection = class {
  ...
  $o(e, t, n, r, i) {
    ...
    return this.Go(e, o, _, n, c).then(((t2) => (__PRIVATE_logDebug(Qt, `Received RPC '${e}' ${s}: `, t2), t2)), ((t2) => {
      throw __PRIVATE_logWarn2(Qt, `RPC '${e}' ${s} failed with error: `, t2, "url: ", o, "request:", n), t2;
    }));
  }
  zo(e, t, n, r, i, s) {
...
var __PRIVATE_WebChannelConnection = class ___PRIVATE_WebChannelConnection extends __PRIVATE_RestConnection {
        ...
        try {
          switch (_.getLastErrorCode()) {
            ...
            case ErrorCode.TIMEOUT:
              __PRIVATE_logDebug(zt, `RPC '${e}' ${s} timed out`), o(new FirestoreError2(D.DEADLINE_EXCEEDED, "Request time out"));
              break;
  ...
  P_(e, t, n) {
    ...
    return __PRIVATE_unguardedEventListen(u, WebChannel.EventType.OPEN, (() => {
      ...
      l || (l = true, __PRIVATE_logWarn2(zt, `RPC '${e}' stream ${r} transport errored. Name:`, t2.name, "Message:", t2.message), h.s_(new FirestoreError2(D.UNAVAILABLE, "The operation could not be completed")));
      ...
      if (!l) {
        ...
        if (s2) {
          ...
          "NOT_FOUND" === t3 && i3.includes("database") && i3.includes("does not exist") && i3.includes(this.databaseId.database) && __PRIVATE_logWarn2(`Database '${this.databaseId.database}' not found. Please check your project configuration.`), void 0 === n3 && (n3 = D.INTERNAL, i3 = "Unknown error status: " + t3 + " with message " + s2.message), // Mark closed so no further events are propagated
          l = true, h.s_(new FirestoreError2(n3, i3)), u.close();
...
var __PRIVATE_DatastoreImpl = class extends Datastore {
  ...
  ia() {
    if (this.ra) throw new FirestoreError2(D.FAILED_PRECONDITION, "The client has already been terminated.");
  }
    ...
    */
    await (function __PRIVATE_raiseWatchSnapshot(e2, t3) {
      ...
      n2.targetMismatches.forEach(((t4, n3) => {
        ...
        if (!r2)
          return;
        e2.Ta.set(t4, r2.withResumeToken(ByteString2.EMPTY_BYTE_STRING, r2.snapshotVersion)), // Cause a hard reset by unwatching and rewatching immediately, but
...
var __PRIVATE_DocumentChangeSet = class {
  constructor() {
    this.wa = new SortedMap(DocumentKey2.comparator);
  }
  track(e) {
...
var __PRIVATE_SyncEngineImpl = class {
  constructor(e, t, n, r, i, s) {
     ...
     * active target.
     */
    this.du = new SortedMap(DocumentKey2.comparator), /**
...
function __PRIVATE_pumpEnqueuedLimboResolutions(e) {
  for (; e.Vu.size > 0 && e.du.size < e.maxConcurrentLimboResolutions; ) {
    ...
    e.Vu.delete(t);
    const n = new DocumentKey2(ResourcePath.fromString(t)), r = e.yu.next();
...
async function __PRIVATE_ensureOfflineComponents(e) {
  if (!e._offlineComponents) if (e._uninitializedComponentsProvider) {
    ...
    try {
      ...
      __PRIVATE_logWarn2("Error using user provided cache. Falling back to memory cache: " + n), await __PRIVATE_setOfflineComponentProvider(e, new __PRIVATE_MemoryOfflineComponentProvider());
    }
...
var FirestoreSettingsImpl = class {
  constructor(e) {
    ...
    if (this.isUsingEmulator = void 0 !== e.emulatorOptions, this.credentials = e.credentials, this.ignoreUndefinedProperties = !!e.ignoreUndefinedProperties, this.localCache = e.localCache, void 0 === e.cacheSizeBytes) this.cacheSizeBytes = Dt;
      ...
      if (-1 !== e.cacheSizeBytes && e.cacheSizeBytes < vt) throw new FirestoreError2(D.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
...
var DocumentReference2 = class _DocumentReference {
  ...
  static fromJSON(e, t, n) {
    if (__PRIVATE_validateJSON(t, _DocumentReference._jsonSchema)) return new _DocumentReference(e, n || null, new DocumentKey2(ResourcePath.fromString(t.referencePath)));
  }
};
DocumentReference2._jsonSchemaVersion = "firestore/documentReference/1.0", DocumentReference2._jsonSchema = {
...
Bytes2._jsonSchemaVersion = "firestore/bytes/1.0", Bytes2._jsonSchema = {
  type: property("string", Bytes2._jsonSchemaVersion),
...
GeoPoint2._jsonSchemaVersion = "firestore/geoPoint/1.0", GeoPoint2._jsonSchema = {
  type: property("string", GeoPoint2._jsonSchemaVersion),
...
var VectorValue2 = class _VectorValue {
  ...
  static fromJSON(e) {
    if (__PRIVATE_validateJSON(e, _VectorValue._jsonSchema)) {
      ...
      throw new FirestoreError2(D.INVALID_ARGUMENT, "Expected 'vectorValues' field to be a number array");
    }
  }
};
VectorValue2._jsonSchemaVersion = "firestore/vectorValue/1.0", VectorValue2._jsonSchema = {
  type: property("string", VectorValue2._jsonSchemaVersion),
...
function __PRIVATE_fieldPathFromArgument(e, t, n) {
  if (
    ...
    // FieldPath.
    (t = getModularInstance(t)) instanceof FieldPath2
...
function __PRIVATE_validateHasExplicitOrderByForLimitToLast(t) {
  if ("L" === t.limitType && 0 === t.explicitOrderBy.length) throw new FirestoreError2(D.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
function count2() {
  return new AggregateField2("count");
}
function getCountFromServer2(t) {
  return getAggregateFromServer2(t, {
    count: count2()
  });
}
function getAggregateFromServer2(t, e) {
  const n = __PRIVATE_cast2(t.firestore, Firestore), r = ensureFirestoreConfigured2(n), s = __PRIVATE_mapToArray(e, ((t2, e2) => new __PRIVATE_AggregateImpl(e2, t2.aggregateType, t2._internalFieldPath)));
  return __PRIVATE_firestoreClientRunAggregateQuery(r, t._query, s).then(((e2) => (
    ...
    */
    (function __PRIVATE_convertToAggregateQuerySnapshot(t2, e3, n2) {
      const r2 = new __PRIVATE_ExpUserDataWriter(t2), s2 = new AggregateQuerySnapshot2(e3, r2, n2);
      return s2;
    })(n, t, e2)
  )));
}
...
var DocumentSnapshot2 = class _DocumentSnapshot extends DocumentSnapshot$1 {
  /** @hideconstructor protected */
  ...
  data(t = {}) {
    if (this._document) {
      if (this._converter) {
        const e = new QueryDocumentSnapshot2(
          this._firestore,
          this._userDataWriter,
          this._key,
          this._document,
   ...
   */
  toJSON() {
    if (this.metadata.hasPendingWrites) throw new FirestoreError2(D.FAILED_PRECONDITION, "DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");
...
DocumentSnapshot2._jsonSchemaVersion = "firestore/documentSnapshot/1.0", DocumentSnapshot2._jsonSchema = {
  type: property("string", DocumentSnapshot2._jsonSchemaVersion),
...
var QuerySnapshot2 = class _QuerySnapshot {
  /** @hideconstructor */
  constructor(t, e, n, r) {
    this._firestore = t, this._userDataWriter = e, this._snapshot = r, this.metadata = new SnapshotMetadata2(r.hasPendingWrites, r.fromCache), this.query = n;
  }
  ...
  forEach(t, e) {
    this._snapshot.docs.forEach(((n) => {
      t.call(e, new QueryDocumentSnapshot2(this._firestore, this._userDataWriter, n.key, n, new SnapshotMetadata2(this._snapshot.mutatedKeys.has(n.key), this._snapshot.fromCache), this.query.converter));
    }));
  }
  /**
  ...
  docChanges(t = {}) {
    ...
    if (e && this._snapshot.excludesMetadataChanges) throw new FirestoreError2(D.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    (function __PRIVATE_changesFromSnapshot(t2, e2) {
      if (t2._snapshot.oldDocs.isEmpty()) {
        ...
        return t2._snapshot.docChanges.map(((n) => {
          const r = new QueryDocumentSnapshot2(t2._firestore, t2._userDataWriter, n.doc.key, n.doc, new SnapshotMetadata2(t2._snapshot.mutatedKeys.has(n.doc.key), t2._snapshot.fromCache), t2.query.converter);
          return n.doc, {
            type: "added",
            doc: r,
            oldIndex: -1,
      ...
      }
      {
        ...
        return t2._snapshot.docChanges.filter(((t3) => e2 || 3 !== t3.type)).map(((e3) => {
          const r = new QueryDocumentSnapshot2(t2._firestore, t2._userDataWriter, e3.doc.key, e3.doc, new SnapshotMetadata2(t2._snapshot.mutatedKeys.has(e3.doc.key), t2._snapshot.fromCache), t2.query.converter);
          let s = -1, a = -1;
   ...
   */
  toJSON() {
    if (this.metadata.hasPendingWrites) throw new FirestoreError2(D.FAILED_PRECONDITION, "QuerySnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");
    const t = {};
    t.type = _QuerySnapshot._jsonSchemaVersion, t.bundleSource = "QuerySnapshot", t.bundleName = __PRIVATE_AutoId2.newId(), this._firestore._databaseId.database, this._firestore._databaseId.projectId;
    const e = [], n = [], r = [];
...
QuerySnapshot2._jsonSchemaVersion = "firestore/querySnapshot/1.0", QuerySnapshot2._jsonSchema = {
  type: property("string", QuerySnapshot2._jsonSchemaVersion),
  bundleSource: property("string", "QuerySnapshot"),
  bundleName: property("string"),
  bundle: property("string")
};
function onSnapshot2(t, ...e) {
  ...
  let o, i, c;
  if (t instanceof DocumentReference2) i = __PRIVATE_cast2(t.firestore, Firestore), c = __PRIVATE_newQueryForPath(t._key.path), o = {
    next: (n2) => {
    ...
    const n2 = __PRIVATE_cast2(t, Query2);
    i = __PRIVATE_cast2(n2.firestore, Firestore), c = n2._query;
    const s2 = new __PRIVATE_ExpUserDataWriter(i);
    o = {
      next: (t2) => {
        e[r] && e[r](new QuerySnapshot2(i, s2, n2, t2));
      },
      error: e[r + 1],
      complete: e[r + 2]
    }, __PRIVATE_validateHasExplicitOrderByForLimitToLast(t._query);
  }
  const h = ensureFirestoreConfigured2(i);
...
function __PRIVATE_convertToDocSnapshot(t, e, n) {
  ...
  return new DocumentSnapshot2(t, s, e._key, r, new SnapshotMetadata2(n.hasPendingWrites, n.fromCache), e.converter);
}
!(function __PRIVATE_registerFirestore(h, d = true) {
  ...
  }), "PUBLIC").setMultipleInstances(true)), registerVersion2(Ut, Ht2, h), // BUILD_TARGET will be replaced by values like esm, cjs, etc during the compilation
...
function docData(ref, options) {
  ...
  return doc3(ref).pipe(map(function(snap) {
...
function collectionData(query3, options) {
  ...
  return collection3(query3).pipe(map(function(arr) {
...
var collectionSnapshots = ɵzoneWrap(collection3, true);
...
var clearIndexedDbPersistence3 = ɵzoneWrap(clearIndexedDbPersistence, true);
var collection4 = ɵzoneWrap(collection, true, 2);
var collectionGroup3 = ɵzoneWrap(collectionGroup, true, 2);
var connectFirestoreEmulator3 = ɵzoneWrap(connectFirestoreEmulator, true);
...
var deleteField3 = ɵzoneWrap(deleteField, true, 2);
var disableNetwork3 = ɵzoneWrap(disableNetwork, true);
...
var documentId3 = ɵzoneWrap(documentId, true, 2);
var enableIndexedDbPersistence3 = ɵzoneWrap(enableIndexedDbPersistence, true);
var enableMultiTabIndexedDbPersistence3 = ɵzoneWrap(enableMultiTabIndexedDbPersistence, true);
var enableNetwork3 = ɵzoneWrap(enableNetwork, true);
...
var getFirestore3 = ɵzoneWrap(getFirestore, true);
var getPersistentCacheIndexManager2 = ɵzoneWrap(getPersistentCacheIndexManager, true);
var increment3 = ɵzoneWrap(increment, true, 2);
var initializeFirestore3 = ɵzoneWrap(initializeFirestore, true);
var limit2 = ɵzoneWrap(limit, true, 2);
var limitToLast2 = ɵzoneWrap(limitToLast, true, 2);
var loadBundle3 = ɵzoneWrap(loadBundle, true);
var namedQuery3 = ɵzoneWrap(namedQuery, true, 2);
...
var queryEqual3 = ɵzoneWrap(queryEqual, true, 2);
var refEqual3 = ɵzoneWrap(refEqual, true, 2);
...
var terminate3 = ɵzoneWrap(terminate, true);
var updateDoc2 = ɵzoneWrap(updateDoc, true, 2);
var vector3 = ɵzoneWrap(vector, true, 2);
var waitForPendingWrites3 = ɵzoneWrap(waitForPendingWrites, true);
...
export {
  ...
  average,
  clearIndexedDbPersistence3 as clearIndexedDbPersistence,
  collection4 as collection,
  ...
  collectionGroup3 as collectionGroup,
  collectionSnapshots,
  connectFirestoreEmulator3 as connectFirestoreEmulator,
  count,
  deleteAllPersistentCacheIndexes2 as deleteAllPersistentCacheIndexes,
  deleteDoc2 as deleteDoc,
  deleteField3 as deleteField,
  disableNetwork3 as disableNetwork,
  disablePersistentCacheIndexAutoCreation2 as disablePersistentCacheIndexAutoCreation,
  doc4 as doc,
  docData2 as docData,
  docSnapshots,
  documentId3 as documentId,
  documentSnapshotFromJSON,
  enableIndexedDbPersistence3 as enableIndexedDbPersistence,
  enableMultiTabIndexedDbPersistence3 as enableMultiTabIndexedDbPersistence,
  enableNetwork3 as enableNetwork,
  ...
  getFirestore3 as getFirestore,
  getPersistentCacheIndexManager2 as getPersistentCacheIndexManager,
  increment3 as increment,
  initializeFirestore3 as initializeFirestore,
  limit2 as limit,
  limitToLast2 as limitToLast,
  loadBundle3 as loadBundle,
  memoryEagerGarbageCollector,
  memoryLocalCache,
  memoryLruGarbageCollector,
  namedQuery3 as namedQuery,
  ...
  startAt2 as startAt,
  sum2 as sum,
  terminate3 as terminate,
  updateDoc2 as updateDoc,
  vector3 as vector,
  waitForPendingWrites3 as waitForPendingWrites,
  where2 as where,
